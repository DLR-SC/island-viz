...
namespace Valve.VR.InteractionSystem
{
	...
	public class Hand : MonoBehaviour
	{
		...
		private void UpdateHovering()
		{
            ...
            //Modify to better suit needs and be cheaper
            float flHoverRadiusScale = OsgiViz.Core.GlobalVar.inverseHologramScale;
			...
			foreach ( Collider collider in overlappingColliders )
			{
                ...
                // Modified to check also if the IgnoreHovering Component is enabled....its faster to switch between hovering modes 
                // by enabling/disabling the component instead of attaching/deattaching it.
				IgnoreHovering ignore = collider.GetComponent<IgnoreHovering>();
				if ( ignore != null && ignore.enabled )
				{
