...
{
    public class HistoryGraphManager_History : HistoryGraphManager
    {
        public HistoryGraphManager_History(HistoryGraph hGraph) : base(hGraph)
        {
        }
        ...
        public override void Init(float r, float c1, float c3, float startTempFrac,
