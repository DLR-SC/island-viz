...
{
    public class Island_HistoryGraphManager_Master : IslandHistoryGraphManager
    {
        public Island_HistoryGraphManager_Master(HistoryGraph historyGraph) : base(historyGraph)
        {
        ...
        public override IEnumerator Init(float r, float c1, float c3, float startTempFrac, int iterations, float mentalDelta)
        {
            ...
            yield return masterLayouter.layout();
        ...
        public override IEnumerator Init(float r, float c1, float c2, float startTempFrac, int iterations, float c5, int maxDepth)
        {
