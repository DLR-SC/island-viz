...
half4 fragForwardBaseInternal (VertexOutputForwardBase i)
{
	...
	circleClip(s.posWorld, hologramCenter.xyz, hologramScale);
	...
	//Hologram Outlines
	hologramCenter.y = 0;
	float3 projectedPosWorld = s.posWorld;
	projectedPosWorld.y = 0;
	float dist = distanceFromPoint(projectedPosWorld, hologramCenter);
	...
	if(percentageDistanceFromBorderToOutlineWidth <= 1.0f)
		c.rgb =  lerp(c.rgb, hologramOutlineColor, percentageDistanceFromBorderToOutlineWidth);
	//
